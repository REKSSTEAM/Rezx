...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ᥀",callback_data="/Song:"..data.sender_user_id_}},{{text=". TeAm REKSS ᥀",url="t.me/QQOQQD"}}} 
...
local Text ='*♡︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ᥀",callback_data="/mp3:"..data.sender_user_id_}},{{text=". TeAm REKSS ᥀",url="t.me/QQOQQD"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ᥀",callback_data="/memz:"..data.sender_user_id_}},{{text=". TeAm REKSS ᥀",url="t.me/QQOQQD"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ᥀",callback_data="/gif:"..data.sender_user_id_}},{{text=". TeAm REKSS ᥀",url="t.me/QQOQQD"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ᥀",callback_data="/photo:"..data.sender_user_id_}},{{text=". TeAm REKSS ᥀",url="t.me/QQOQQD"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ᥀",callback_data="/anime:"..data.sender_user_id_}},{{text=". TeAm REKSS ᥀",url="t.me/QQOQQD"}}} 
...
local Groups = DevAbs:smembers(REKSS..'Abs:Groups')  
local UsersBot = DevAbs:smembers(REKSS..'Abs:Users')  
local Get_Json = '{"BotId": '..REKSS..','  
if #UsersBot ~= 0 then 
...
local Malk = DevAbs:smembers(REKSS..":Abs:AbsConstructor:"..v)
local President = DevAbs:smembers(REKSS.."Abs:BasicConstructor:"..v)
local Constructor = DevAbs:smembers(REKSS..":Abs:Constructor:"..v)
local Manager = DevAbs:smembers(REKSS.."Abs:Managers:"..v)
local Admin = DevAbs:smembers(REKSS.."Abs:Admins:"..v)
local Vips = DevAbs:smembers(REKSS.."Abs:VipMem:"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
File:write(Get_Json)
File:close()
return sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..REKSS..'.json', '',dl_cb, nil)
end
